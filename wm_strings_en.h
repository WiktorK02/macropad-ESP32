...
".c,body{text-align:center;font-family:verdana;background-color:#20292F}div,input,select{padding:5px;font-size:1em;margin:5px 0;box-sizing:border-box;color:#fff}"
"input,button,select,.msg{border-radius:.3rem;width: 100%;background-color:#37555F}input[type=radio],input[type=checkbox]{width:auto}"
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#46484f;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
